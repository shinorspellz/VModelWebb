            ...
            <VMContainer>
              <div className="flex flex-col md:flex-row w-full mx-auto md:items-center md:pt-[80px] px-[10px]">
                <div className="h-auto mb-12 md:mb-0 md:h-[80vh] w-full rounded-md overflow-hidden relative">
                    ...
                    <>
                      ...
                      <div className="absolute left-3 md:left-0 bottom-2 md:bottom-0 z-30">
                        <div className="self-start xl:p-16 md:p-12">
                          <div className="font-medium sm:font-bold text-white -mb-1 text-[15px] md:text-3xl md:mb-3 richtext">
                            Welcome
                          </div>
                          <p className="text-[12px] opacity-70 md:text-lg richtext text-white">
                            Vmodel App
                          </p>
                        </div>
                      </div>
                  ...
                  >
                    <button
                      className={`h-8 w-8 transition-all duration-[.3s] mob-svg md:h-16 md:w-16 flex ${
                        isPlaying ? "isPlaying" : ""
                      } z-20 rounded-full border-white border place-items-center justify-center absolute -translate-x-1/2 left-1/2 -translate-y-1/2 top-1/2`}
                      type="button"
                      onClick={_handlePlay}
                      aria-label="VModel App Preview"
                    >
                      {!isPlaying ? (
